...
const GraduationBanner: React.FC<GraduationBannerProps> = ({ imageUrl }) => {
  return (
    ...
    >
      <div className="graduation-overlay absolute inset-0" />
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 items-center">
          ...
          <div className="space-y-2 text-center md:text-left">
            <h3 className="graduation-title text-3xl md:text-4xl font-light">
            ...
            <p className="graduation-subtitle text-lg leading-relaxed max-w-xl">
              Pastelería profesional con formación en el Instituto Argentino de Gastronomía.
            </p>

            <p className="graduation-note text-sm italic">
