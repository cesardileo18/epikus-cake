    ...
    >
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6">
          {items.map((item, index) => (
            <button
              ...
              className="group relative rounded-2xl p-1 transform hover:-translate-y-2 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2"
              style={{
            ...
            >
                ...
                <div className="absolute inset-0 hidden md:flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300">
                  <div className="relative">
                    ...
                    <div className="relative w-16 h-16 bg-white rounded-full flex items-center justify-center shadow-2xl transform scale-90 group-hover:scale-100 transition-transform duration-300">
                      <svg className="w-7 h-7" style={{ color: 'var(--color-brand)' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div
                className="absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-50 blur-xl -z-10 transition-opacity duration-300"
      ...
      {selected && (
        ...
        >
          ...
          <div
            className="relative max-w-5xl w-full p-2 rounded-2xl"
            style={{ background: 'var(--gradient-brand)', animation: 'scaleIn 0.3s ease-out' }}
